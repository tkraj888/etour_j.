  ...
  return (
    <div>
      ...
      <div className="registration">
        <div className="container regidetail">
          <div>
            <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              {errors.password && <p>Please check the Password length:6-15 (Must contain UpperCase LowerCase SpecialCharacter 
                Numeric)</p>}
              <div className="second-input">
                <Form.Field>
                  {/* <label>Password</label> */}
              ...
              {errors.confirm_password && (
                <p>Please check the confirm_password</p>
              )}
